...
/*rf_extern rf_bool rf_audio_init()
{
    rf_valid        valid          = {0};
...
rf_extern void rf_init_audio_device(void)
{
...
rf_extern void rf_close_audio_device(void)
{
...
rf_extern bool rf_is_audio_device_ready(void)
{
    return rf_global_audio_ctx.valid;
}

rf_extern void rf_set_master_volume(float volume)
{
