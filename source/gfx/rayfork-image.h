...
RF_API rf_image rf_load_image_from_file_data(const void* src, rf_int src_size, rf_desired_channels channels, rf_allocator allocator, rf_allocator temp_allocator);
