...
rf_extern rf_vec2 rf_center_to_screen(float w, float h)
{
...
rf_extern void rf_clear(rf_color color)
{
...
rf_extern void rf_end()
{
    rf_gfx_draw();
}

// Initialize 2D mode with custom camera (2D)
rf_extern void rf_begin_2d(rf_camera2d camera)
{
    rf_gfx_draw();
...
rf_extern void rf_begin_3d(rf_camera3d camera)
{
    rf_gfx_draw();
...
rf_extern void rf_begin_render_to_texture(rf_render_texture2d target)
{
    rf_gfx_draw();
...
rf_extern void rf_end_render_to_texture()
{
    rf_gfx_draw();
...
rf_extern void rf_begin_scissor_mode(int x, int y, int width, int height)
{
...
// End scissor mode
rf_extern void rf_end_scissor_mode()
{
    rf_gfx_draw(); // Force drawing elements
...
rf_extern void rf_begin_shader(rf_shader shader)
{
...
rf_extern void rf_end_shader()
{
    rf_begin_shader(rf_ctx.default_shader);
}

// Begin blending mode (alpha, additive, multiplied). Default blend mode is alpha
rf_extern void rf_begin_blend_mode(rf_blend_mode mode)
{
    rf_gfx_blend_mode(mode);
}

// End blending mode (reset to default: alpha blending)
rf_extern void rf_end_blend_mode()
{
    rf_gfx_blend_mode(RF_BLEND_ALPHA);
}

// Draw a pixel
rf_extern void rf_draw_pixel(int pos_x, int pos_y, rf_color color)
{
...
rf_extern void rf_draw_pixel_v(rf_vec2 position, rf_color color)
{
    rf_draw_pixel(position.x, position.y, color);
}

// Draw a line
rf_extern void rf_draw_line(int startPosX, int startPosY, int endPosX, int endPosY, rf_color color)
{
    rf_gfx_begin(RF_LINES);
    rf_gfx_color4ub(color.r, color.g, color.b, color.a);
...
rf_extern void rf_draw_line_v(rf_vec2 startPos, rf_vec2 endPos, rf_color color)
{
    rf_draw_line(startPos.x, startPos.y, endPos.x, endPos.y, color);
}

// Draw a line defining thickness
rf_extern void rf_draw_line_ex(rf_vec2 start_pos, rf_vec2 end_pos, float thick, rf_color color)
{
...
rf_extern void rf_draw_line_bezier(rf_vec2 start_pos, rf_vec2 end_pos, float thick, rf_color color)
{
...
// Draw lines sequence
rf_extern void rf_draw_line_strip(rf_vec2 *points, int points_count, rf_color color)
{
    if (points_count >= 2)
    {
...
rf_extern void rf_draw_circle(int center_x, int center_y, float radius, rf_color color)
{
    rf_draw_circle_sector((rf_vec2) {center_x, center_y }, radius, 0, 360, 36, color);
}

// Draw a color-filled circle (Vector version)
rf_extern void rf_draw_circle_v(rf_vec2 center, float radius, rf_color color)
{
    rf_draw_circle(center.x, center.y, radius, color);
}

// Draw a piece of a circle
rf_extern void rf_draw_circle_sector(rf_vec2 center, float radius, int start_angle, int end_angle, int segments, rf_color color)
{
...
rf_extern void rf_draw_circle_sector_lines(rf_vec2 center, float radius, int start_angle, int end_angle, int segments, rf_color color)
{
...
rf_extern void rf_draw_circle_gradient(int center_x, int center_y, float radius, rf_color color1, rf_color color2)
{
...
// Draw circle outline
rf_extern void rf_draw_circle_lines(int center_x, int center_y, float radius, rf_color color)
{
...
rf_extern void rf_draw_ring(rf_vec2 center, float inner_radius, float outer_radius, int start_angle, int end_angle, int segments, rf_color color)
{
...
rf_extern void rf_draw_ring_lines(rf_vec2 center, float inner_radius, float outer_radius, int start_angle, int end_angle, int segments, rf_color color)
{
    if (start_angle == end_angle) return;
...
rf_extern void rf_draw_rectangle(int posX, int posY, int width, int height, rf_color color)
{
    rf_draw_rectangle_v((rf_vec2){ (float)posX, (float)posY }, (rf_vec2){ (float)width, (float)height }, color);
}

// Draw a color-filled rectangle (Vector version)
rf_extern void rf_draw_rectangle_v(rf_vec2 position, rf_vec2 size, rf_color color)
{
    rf_draw_rectangle_pro((rf_rec) { position.x, position.y, size.x, size.y }, (rf_vec2){ 0.0f, 0.0f }, 0.0f, color);
}

// Draw a color-filled rectangle
rf_extern void rf_draw_rectangle_rec(rf_rec rec, rf_color color)
{
    rf_draw_rectangle_pro(rec, (rf_vec2){ 0.0f, 0.0f }, 0.0f, color);
}

// Draw a color-filled rectangle with pro parameters
rf_extern void rf_draw_rectangle_pro(rf_rec rec, rf_vec2 origin, float rotation, rf_color color)
{
    rf_gfx_enable_texture(rf_get_shapes_texture().id);
...
rf_extern void rf_draw_rectangle_gradient_v(int pos_x, int pos_y, int width, int height, rf_color color1, rf_color color2)
{
...
// NOTE: Gradient goes from bottom (color1) to top (color2)
rf_extern void rf_draw_rectangle_gradient_h(int pos_x, int pos_y, int width, int height, rf_color color1, rf_color color2)
{
...
rf_extern void rf_draw_rectangle_gradient(rf_rec rec, rf_color col1, rf_color col2, rf_color col3, rf_color col4)
{
    rf_gfx_enable_texture(rf_get_shapes_texture().id);
...
rf_extern void rf_draw_rectangle_outline(rf_rec rec, int line_thick, rf_color color)
{
...
rf_extern void rf_draw_rectangle_rounded(rf_rec rec, float roundness, int segments, rf_color color)
{
...
rf_extern void rf_draw_rectangle_rounded_lines(rf_rec rec, float roundness, int segments, int line_thick, rf_color color)
{
...
rf_extern void rf_draw_triangle(rf_vec2 v1, rf_vec2 v2, rf_vec2 v3, rf_color color)
{
...
// NOTE: Vertex must be provided in counter-clockwise order
rf_extern void rf_draw_triangle_lines(rf_vec2 v1, rf_vec2 v2, rf_vec2 v3, rf_color color)
{
...
rf_extern void rf_draw_triangle_fan(rf_vec2 *points, int points_count, rf_color color)
{
    if (points_count >= 3)
    {
...
rf_extern void rf_draw_triangle_strip(rf_vec2 *points, int points_count, rf_color color)
{
    if (points_count >= 3)
    {
        if (rf_gfx_check_buffer_limit(points_count)) rf_gfx_draw();
...
rf_extern void rf_draw_poly(rf_vec2 center, int sides, float radius, float rotation, rf_color color)
{
    if (sides < 3) sides = 3;
...
rf_extern void rf_draw_texture(rf_texture2d texture, int x, int y, rf_color tint)
{
    rf_draw_texture_ex(texture, x, y, texture.width, texture.height, 0, tint);
}

// Draw a rf_texture2d with extended parameters
rf_extern void rf_draw_texture_ex(rf_texture2d texture, int x, int y, int w, int h, float rotation, rf_color tint)
{
...
rf_extern void rf_draw_texture_region(rf_texture2d texture, rf_rec source_rec, rf_rec dest_rec, rf_vec2 origin, float rotation, rf_color tint)
{
...
rf_extern void rf_draw_texture_npatch(rf_texture2d texture, rf_npatch_info n_patch_info, rf_rec dest_rec, rf_vec2 origin, float rotation, rf_color tint)
{
    if (texture.id > 0)
    {
        float width = (float)texture.width;
...
rf_extern void rf_draw_string(const char* text, int text_len, int posX, int posY, int font_size, rf_color color)
{
    // Check if default font has been loaded
    if (rf_get_builtin_bitmap_font().texture.id == 0 || text_len == 0) return;
    ...
    rf_draw_string_ex(rf_get_builtin_bitmap_font(), text, text_len, position, (float)font_size, (float)spacing, color);
}

// Draw text with custom font
rf_extern void rf_draw_string_ex(rf_bitmap_font font, const char* text, int text_len, rf_vec2 position, float font_size, float spacing, rf_color tint)
{
...
// Draw text wrapped
rf_extern void rf_draw_string_wrap(rf_bitmap_font font, const char* text, int text_len, rf_vec2 position, float font_size, float spacing, rf_color tint, float wrap_width, rf_text_wrap_mode mode)
{
...
rf_extern void rf_draw_string_rec(rf_bitmap_font font, const char* text, int text_len, rf_rec rec, float font_size, float spacing, rf_text_wrap_mode wrap, rf_color tint)
{
...
rf_extern void rf_draw_text(const char* text, int posX, int posY, int font_size, rf_color color) { rf_draw_string(text, strlen(text), posX, posY, font_size, color); }

rf_extern void rf_draw_text_ex(rf_bitmap_font font, const char* text, rf_vec2 position, float fontSize, float spacing, rf_color tint) { rf_draw_string_ex(font, text, strlen(text), position, fontSize, spacing, tint); }

rf_extern void rf_draw_text_wrap(rf_bitmap_font font, const char* text, rf_vec2 position, float font_size, float spacing, rf_color tint, float wrap_width, rf_text_wrap_mode mode) { rf_draw_string_wrap(font, text, strlen(text), position, font_size, spacing, tint, wrap_width, mode); }

rf_extern void rf_draw_text_rec(rf_bitmap_font font, const char* text, rf_rec rec, float font_size, float spacing, rf_text_wrap_mode wrap, rf_color tint) { rf_draw_string_rec(font, text, strlen(text), rec, font_size, spacing, wrap, tint); }

rf_extern void rf_draw_line3d(rf_vec3 start_pos, rf_vec3 end_pos, rf_color color)
{
    rf_gfx_begin(RF_LINES);
    rf_gfx_color4ub(color.r, color.g, color.b, color.a);
...
rf_extern void rf_draw_circle3d(rf_vec3 center, float radius, rf_vec3 rotation_axis, float rotationAngle, rf_color color)
{
    if (rf_gfx_check_buffer_limit(2 * 36)) rf_gfx_draw();
...
rf_extern void rf_draw_cube(rf_vec3 position, float width, float height, float length, rf_color color)
{
    float x = 0.0f;
    float y = 0.0f;
    float z = 0.0f;
...
// Draw cube wires
rf_extern void rf_draw_cube_wires(rf_vec3 position, float width, float height, float length, rf_color color)
{
    float x = 0.0f;
    float y = 0.0f;
    float z = 0.0f;
...
// Draw cube
// NOTE: Cube position is the center position
rf_extern void rf_draw_cube_texture(rf_texture2d texture, rf_vec3 position, float width, float height, float length, rf_color color)
{
    float x = position.x;
    float y = position.y;
    float z = position.z;
...
// Draw sphere
rf_extern void rf_draw_sphere(rf_vec3 center_pos, float radius, rf_color color)
{
    rf_draw_sphere_ex(center_pos, radius, 16, 16, color);
}

// Draw sphere with extended parameters
rf_extern void rf_draw_sphere_ex(rf_vec3 center_pos, float radius, int rings, int slices, rf_color color)
{
...
// Draw sphere wires
rf_extern void rf_draw_sphere_wires(rf_vec3 center_pos, float radius, int rings, int slices, rf_color color)
{
    int num_vertex = (rings + 2)*slices*6;
    if (rf_gfx_check_buffer_limit(num_vertex)) rf_gfx_draw();
...
rf_extern void rf_draw_cylinder(rf_vec3 position, float radius_top, float radius_bottom, float height, int sides, rf_color color)
{
    if (sides < 3) sides = 3;
...
// NOTE: It could be also used for pyramid and cone
rf_extern void rf_draw_cylinder_wires(rf_vec3 position, float radius_top, float radius_bottom, float height, int sides, rf_color color)
{
    if (sides < 3) sides = 3;
...
// Draw a plane
rf_extern void rf_draw_plane(rf_vec3 center_pos, rf_vec2 size, rf_color color)
{
    if (rf_gfx_check_buffer_limit(4)) rf_gfx_draw();
...
// Draw a ray line
rf_extern void rf_draw_ray(rf_ray ray, rf_color color)
{
    float scale = 10000;
...
rf_extern void rf_draw_grid(int slices, float spacing)
{
...
// Draw gizmo
rf_extern void rf_draw_gizmo(rf_vec3 position)
{
    // NOTE: RGB = XYZ
    float length = 1.0f;
...
rf_extern void rf_draw_model(rf_model model, rf_vec3 position, float scale, rf_color tint)
{
...
rf_extern void rf_draw_model_ex(rf_model model, rf_vec3 position, rf_vec3 rotation_axis, float rotationAngle, rf_vec3 scale, rf_color tint)
{
...
rf_extern void rf_draw_model_wires(rf_model model, rf_vec3 position, rf_vec3 rotation_axis, float rotationAngle, rf_vec3 scale, rf_color tint)
{
...
rf_extern void rf_draw_bounding_box(rf_bounding_box box, rf_color color)
{
    rf_vec3 size;
...
// Draw a billboard
rf_extern void rf_draw_billboard(rf_camera3d camera, rf_texture2d texture, rf_vec3 center, float size, rf_color tint)
{
    rf_rec source_rec = {0.0f, 0.0f, (float)texture.width, (float)texture.height };
...
rf_extern void rf_draw_billboard_rec(rf_camera3d camera, rf_texture2d texture, rf_rec source_rec, rf_vec3 center, float size, rf_color tint)
{
