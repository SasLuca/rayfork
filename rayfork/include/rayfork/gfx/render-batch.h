...
typedef struct rf_one_element_vertex_buffer
{
    ...
    rf_gfx_texcoord_data_type     texcoords [1 * rf_gdx_texcoord_component_count    ];
...
typedef struct rf_default_vertex_buffer
{
    ...
    rf_gfx_texcoord_data_type     texcoords [RF_DEFAULT_BATCH_ELEMENTS_COUNT * rf_gdx_texcoord_component_count    ];
