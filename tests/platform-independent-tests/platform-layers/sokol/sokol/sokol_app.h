...
typedef void  (GL_APIENTRY *PFN_glGenBuffers)(GLsizei n, GLuint * vertex_buffers);
...
typedef void  (GL_APIENTRY *PFN_glDeleteBuffers)(GLsizei n, const GLuint * vertex_buffers);
